            ...
            <div class="card">
                ...
                <table class="table datatable-basic">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th width="10%">Nomor Plat</th>
                            <th width="10%" >Kode Unit</th>
                            <th width="10%" >Nomor Body</th>
                            <th >Merek</th>
                    ...
                    <tbody>
                        @foreach ($result as $item)
                            <tr>
                                <td>{{ $loop->index+1 }}</td>
                                <td>{{ Str::ucfirst($item['no_kendaraan']) }}</td>
                                <td>{{ Str::ucfirst($item['kode_unit']) }}</td>
                                <td>{{ Str::ucfirst($item['no_body']) }}</td>
                                <td>{{ Str::ucfirst($item['merk']) }}</td>
                                <td>{{ Str::ucfirst($item['jenis_kendaraan']) }}</td>
                                <td>{{ Str::ucfirst($item['kategori']) }}</td>
                                <td>{{ Str::ucfirst($item['trayek']) }}</td>
