            ...
            <div class="card">
                ...
                <table class="table datatable-basic">
                    <thead>
                        <tr>
                            <th width="20%">Nama</th>
                            <th width="20%">Kolom Kiri</th>
                            <th width="20%">Kolom Kanan</th>
                            <th width="20%">Kursi Belakang</th>
                            <th width="20%">Total Kursi</th>
                    ...
                    <tbody>
                        @foreach ($result as $item)
                            <tr>
                                ...
                                <td>{{ Str::ucfirst($item['kolom_kiri']) }}</td>
                                <td>{{ Str::ucfirst($item['kolom_kanan']) }}</td>
                                <td>{{ Str::ucfirst($item['seat_belakang']) }}</td>
                                <td>{{ Str::ucfirst($item['total_seat']) }}</td>
