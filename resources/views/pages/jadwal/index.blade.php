            ...
            <div class="card">
                ...
                <table class="table datatable-basic">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th width="20%">Trayek</th>
                            <th width="30%">Waktu Keberangkatan</th>
                            <th width="10%">Waktu Kedatangan</th>
                    ...
                    <tbody>
                        @foreach ($result as $item)
                            <tr>
                                ...
                                <td>{{ Str::ucfirst($item['waktu_keberangkatan']) }}</td>
                                <td>{{ Str::ucfirst($item['waktu_kedataangan']) }}</td>
